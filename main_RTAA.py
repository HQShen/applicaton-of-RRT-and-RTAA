# -*- coding: utf-8 -*-
"""
Created on Sat May 18 02:25:43 2019
...
def runtest(mapfile, start, goal, verbose = True):
  ...
  RP = RTAA.RobotPlanner(boundary, blocks,start,goal)
  ...
  return success, numofmoves, distofmoves, timecost


def test_single_cube():    
  start = np.array([2.3, 2.3, 1.3])
  goal = np.array([7.0, 7.0, 6.0])
  success, numofmoves,distofmoves,timecost = runtest('./maps/single_cube.txt', start, goal, True)
...
def test_maze():
  ...
  success, numofmoves,distofmoves,timecost = runtest('./maps/maze.txt', start, goal, True)
  print('Success: %r'%success)
  print('Number of Moves: %i'%numofmoves)
  print('Distance of Moves: %f'%distofmoves)
  print('Total time: %f'%timecost)
...
def test_window():
  ...
  success, numofmoves,distofmoves,timecost = runtest('./maps/window.txt', start, goal, True)
  print('Success: %r'%success)
  print('Number of Moves: %i'%numofmoves)
  print('Distance of Moves: %f'%distofmoves)
  print('Total time: %f'%timecost)
...
def test_tower():
  ...
  success, numofmoves,distofmoves,timecost = runtest('./maps/tower.txt', start, goal, True)
  print('Success: %r'%success)
  print('Number of Moves: %i'%numofmoves)
  print('Distance of Moves: %f'%distofmoves)
  print('Total time: %f'%timecost)
...
def test_flappy_bird():
  ...
  success, numofmoves,distofmoves,timecost = runtest('./maps/flappy_bird.txt', start, goal, True)
  print('Success: %r'%success)
  print('Number of Moves: %i'%numofmoves) 
  print('Distance of Moves: %f'%distofmoves)
  print('Total time: %f'%timecost)
...
def test_room():
  ...
  success, numofmoves,distofmoves,timecost = runtest('./maps/room.txt', start, goal, True)
  print('Success: %r'%success)
  print('Number of Moves: %i'%numofmoves)
  print('Distance of Moves: %f'%distofmoves)
  print('Total time: %f'%timecost)
...
def test_monza():
  ...
  success, numofmoves,distofmoves,timecost = runtest('./maps/monza.txt', start, goal, True)
  print('Success: %r'%success)
  print('Number of Moves: %i'%numofmoves)
  print('Distance of Moves: %f'%distofmoves)
  print('Total time: %f'%timecost)
